...
function down(m,n){
	...
	if(o=='none'){
		...
		document.getElementById(n).style.background = "url(./admin/files/images/menubg.jpg)";
	}else{
		document.getElementById(m).style.display = "none";
		document.getElementById(n).style.background = "url(./admin/files/images/menubg1.jpg)";
	}
}