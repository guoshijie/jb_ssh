...
<html>
  ...
  <body leftmargin="8" topmargin="8">
    ...
    <!--  内容列表   -->
	<form action="updateNews.action" name="form2" method="post" id="form2" >
	...
	<tr bgcolor="#FFFFFF" >
		...
		<td>
			<textarea rows="2" cols="25" name="title" id="title" ><s:property value="#request.newsById.title"/></textarea>
	...
	<tr bgcolor="#FAFAF1" align="center">
		<td height="28" colspan="13">
			&nbsp;
			<input type="submit" class="coolbg" value="更新">
